...
import 'clas_goles_en_contra2425_model.dart';
export 'clas_goles_en_contra2425_model.dart';

class ClasGolesEnContra2425Widget extends StatefulWidget {
  const ClasGolesEnContra2425Widget({super.key});

  @override
  State<ClasGolesEnContra2425Widget> createState() =>
      _ClasGolesEnContra2425WidgetState();
}

class _ClasGolesEnContra2425WidgetState
    extends State<ClasGolesEnContra2425Widget> {
  late ClasGolesEnContra2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasGolesEnContra2425Model());
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed('VerClasificaciones2425');
