...
import 'clas_t_f_a_p2526_model.dart';
export 'clas_t_f_a_p2526_model.dart';

class ClasTFAP2526Widget extends StatefulWidget {
  const ClasTFAP2526Widget({super.key});

  @override
  State<ClasTFAP2526Widget> createState() => _ClasTFAP2526WidgetState();
}

class _ClasTFAP2526WidgetState extends State<ClasTFAP2526Widget> {
  late ClasTFAP2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasTFAP2526Model());
