...
import 'clas_goles_en_contra_model.dart';
export 'clas_goles_en_contra_model.dart';

class ClasGolesEnContraWidget extends StatefulWidget {
  const ClasGolesEnContraWidget({super.key});

  @override
  State<ClasGolesEnContraWidget> createState() =>
      _ClasGolesEnContraWidgetState();
}

class _ClasGolesEnContraWidgetState extends State<ClasGolesEnContraWidget> {
  late ClasGolesEnContraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasGolesEnContraModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed('VerClasificaciones');
