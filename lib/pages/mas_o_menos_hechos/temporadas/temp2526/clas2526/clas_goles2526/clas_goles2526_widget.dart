...
import 'clas_goles2526_model.dart';
export 'clas_goles2526_model.dart';

class ClasGoles2526Widget extends StatefulWidget {
  const ClasGoles2526Widget({super.key});

  @override
  State<ClasGoles2526Widget> createState() => _ClasGoles2526WidgetState();
}

class _ClasGoles2526WidgetState extends State<ClasGoles2526Widget> {
  late ClasGoles2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasGoles2526Model());
