...
import 'clas_goles_a_favor2526_model.dart';
export 'clas_goles_a_favor2526_model.dart';

class ClasGolesAFavor2526Widget extends StatefulWidget {
  const ClasGolesAFavor2526Widget({super.key});

  @override
  State<ClasGolesAFavor2526Widget> createState() =>
      _ClasGolesAFavor2526WidgetState();
}

class _ClasGolesAFavor2526WidgetState extends State<ClasGolesAFavor2526Widget> {
  late ClasGolesAFavor2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasGolesAFavor2526Model());
