...
import 'clas_pases2425_model.dart';
export 'clas_pases2425_model.dart';

class ClasPases2425Widget extends StatefulWidget {
  const ClasPases2425Widget({super.key});

  @override
  State<ClasPases2425Widget> createState() => _ClasPases2425WidgetState();
}

class _ClasPases2425WidgetState extends State<ClasPases2425Widget> {
  late ClasPases2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasPases2425Model());
