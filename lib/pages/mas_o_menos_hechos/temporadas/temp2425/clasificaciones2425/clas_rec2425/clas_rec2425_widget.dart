...
import 'clas_rec2425_model.dart';
export 'clas_rec2425_model.dart';

class ClasRec2425Widget extends StatefulWidget {
  const ClasRec2425Widget({super.key});

  @override
  State<ClasRec2425Widget> createState() => _ClasRec2425WidgetState();
}

class _ClasRec2425WidgetState extends State<ClasRec2425Widget> {
  late ClasRec2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasRec2425Model());
