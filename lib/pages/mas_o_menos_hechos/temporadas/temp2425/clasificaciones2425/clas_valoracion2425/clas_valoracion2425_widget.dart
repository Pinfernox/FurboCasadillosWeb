...
import 'clas_valoracion2425_model.dart';
export 'clas_valoracion2425_model.dart';

class ClasValoracion2425Widget extends StatefulWidget {
  const ClasValoracion2425Widget({super.key});

  @override
  State<ClasValoracion2425Widget> createState() =>
      _ClasValoracion2425WidgetState();
}

class _ClasValoracion2425WidgetState extends State<ClasValoracion2425Widget> {
  late ClasValoracion2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasValoracion2425Model());
