...
import 'clas_rec_model.dart';
export 'clas_rec_model.dart';

class ClasRecWidget extends StatefulWidget {
  const ClasRecWidget({super.key});

  @override
  State<ClasRecWidget> createState() => _ClasRecWidgetState();
}

class _ClasRecWidgetState extends State<ClasRecWidget> {
  late ClasRecModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasRecModel());
