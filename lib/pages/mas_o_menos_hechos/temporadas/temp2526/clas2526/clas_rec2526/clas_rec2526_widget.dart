...
import 'clas_rec2526_model.dart';
export 'clas_rec2526_model.dart';

class ClasRec2526Widget extends StatefulWidget {
  const ClasRec2526Widget({super.key});

  @override
  State<ClasRec2526Widget> createState() => _ClasRec2526WidgetState();
}

class _ClasRec2526WidgetState extends State<ClasRec2526Widget> {
  late ClasRec2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasRec2526Model());
