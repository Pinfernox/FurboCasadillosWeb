...
import 'clas_victorias2526_model.dart';
export 'clas_victorias2526_model.dart';

class ClasVictorias2526Widget extends StatefulWidget {
  const ClasVictorias2526Widget({super.key});

  @override
  State<ClasVictorias2526Widget> createState() =>
      _ClasVictorias2526WidgetState();
}

class _ClasVictorias2526WidgetState extends State<ClasVictorias2526Widget> {
  late ClasVictorias2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasVictorias2526Model());
