...
import 'clas_pases_model.dart';
export 'clas_pases_model.dart';

class ClasPasesWidget extends StatefulWidget {
  const ClasPasesWidget({super.key});

  @override
  State<ClasPasesWidget> createState() => _ClasPasesWidgetState();
}

class _ClasPasesWidgetState extends State<ClasPasesWidget> {
  late ClasPasesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasPasesModel());
