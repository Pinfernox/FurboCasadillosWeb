...
import 'clas_paradas2425_model.dart';
export 'clas_paradas2425_model.dart';

class ClasParadas2425Widget extends StatefulWidget {
  const ClasParadas2425Widget({super.key});

  @override
  State<ClasParadas2425Widget> createState() => _ClasParadas2425WidgetState();
}

class _ClasParadas2425WidgetState extends State<ClasParadas2425Widget> {
  late ClasParadas2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasParadas2425Model());
