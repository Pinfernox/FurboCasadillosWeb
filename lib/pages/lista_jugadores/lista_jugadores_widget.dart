...
import 'lista_jugadores_model.dart';
export 'lista_jugadores_model.dart';

class ListaJugadoresWidget extends StatefulWidget {
  const ListaJugadoresWidget({super.key});

  @override
  State<ListaJugadoresWidget> createState() => _ListaJugadoresWidgetState();
}

class _ListaJugadoresWidgetState extends State<ListaJugadoresWidget> {
  late ListaJugadoresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaJugadoresModel());
