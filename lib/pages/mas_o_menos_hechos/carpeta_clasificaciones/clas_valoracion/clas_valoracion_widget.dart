...
import 'clas_valoracion_model.dart';
export 'clas_valoracion_model.dart';

class ClasValoracionWidget extends StatefulWidget {
  const ClasValoracionWidget({super.key});

  @override
  State<ClasValoracionWidget> createState() => _ClasValoracionWidgetState();
}

class _ClasValoracionWidgetState extends State<ClasValoracionWidget> {
  late ClasValoracionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasValoracionModel());
