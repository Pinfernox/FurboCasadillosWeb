...
import 'clas_goles_model.dart';
export 'clas_goles_model.dart';

class ClasGolesWidget extends StatefulWidget {
  const ClasGolesWidget({super.key});

  @override
  State<ClasGolesWidget> createState() => _ClasGolesWidgetState();
}

class _ClasGolesWidgetState extends State<ClasGolesWidget> {
  late ClasGolesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasGolesModel());
