...
import 'lista_jugadores2526_model.dart';
export 'lista_jugadores2526_model.dart';

class ListaJugadores2526Widget extends StatefulWidget {
  const ListaJugadores2526Widget({super.key});

  @override
  State<ListaJugadores2526Widget> createState() =>
      _ListaJugadores2526WidgetState();
}

class _ListaJugadores2526WidgetState extends State<ListaJugadores2526Widget> {
  late ListaJugadores2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaJugadores2526Model());
