...
import 'clas_paradas2526_model.dart';
export 'clas_paradas2526_model.dart';

class ClasParadas2526Widget extends StatefulWidget {
  const ClasParadas2526Widget({super.key});

  @override
  State<ClasParadas2526Widget> createState() => _ClasParadas2526WidgetState();
}

class _ClasParadas2526WidgetState extends State<ClasParadas2526Widget> {
  late ClasParadas2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasParadas2526Model());
