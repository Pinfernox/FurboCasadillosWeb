...
import 'clas_pases2526_model.dart';
export 'clas_pases2526_model.dart';

class ClasPases2526Widget extends StatefulWidget {
  const ClasPases2526Widget({super.key});

  @override
  State<ClasPases2526Widget> createState() => _ClasPases2526WidgetState();
}

class _ClasPases2526WidgetState extends State<ClasPases2526Widget> {
  late ClasPases2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasPases2526Model());
