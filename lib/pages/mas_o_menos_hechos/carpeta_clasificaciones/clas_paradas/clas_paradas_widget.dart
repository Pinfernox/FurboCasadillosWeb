...
import 'clas_paradas_model.dart';
export 'clas_paradas_model.dart';

class ClasParadasWidget extends StatefulWidget {
  const ClasParadasWidget({super.key});

  @override
  State<ClasParadasWidget> createState() => _ClasParadasWidgetState();
}

class _ClasParadasWidgetState extends State<ClasParadasWidget> {
  late ClasParadasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasParadasModel());
