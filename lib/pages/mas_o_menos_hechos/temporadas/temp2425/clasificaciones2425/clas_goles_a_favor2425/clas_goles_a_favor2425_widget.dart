...
import 'clas_goles_a_favor2425_model.dart';
export 'clas_goles_a_favor2425_model.dart';

class ClasGolesAFavor2425Widget extends StatefulWidget {
  const ClasGolesAFavor2425Widget({super.key});

  @override
  State<ClasGolesAFavor2425Widget> createState() =>
      _ClasGolesAFavor2425WidgetState();
}

class _ClasGolesAFavor2425WidgetState extends State<ClasGolesAFavor2425Widget> {
  late ClasGolesAFavor2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasGolesAFavor2425Model());
