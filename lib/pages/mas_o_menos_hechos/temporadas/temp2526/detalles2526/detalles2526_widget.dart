...
import 'detalles2526_model.dart';
export 'detalles2526_model.dart';

class Detalles2526Widget extends StatefulWidget {
  const Detalles2526Widget({
    super.key,
    required this.foto,
  ...
  @override
  State<Detalles2526Widget> createState() => _Detalles2526WidgetState();
}

class _Detalles2526WidgetState extends State<Detalles2526Widget>
    with TickerProviderStateMixin {
  late Detalles2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Detalles2526Model());
                ...
                children: [
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed('ListaJugadores2425');
