...
import 'repeticiones_model.dart';
export 'repeticiones_model.dart';

class RepeticionesWidget extends StatefulWidget {
  const RepeticionesWidget({super.key});

  @override
  State<RepeticionesWidget> createState() => _RepeticionesWidgetState();
}

class _RepeticionesWidgetState extends State<RepeticionesWidget> {
  late RepeticionesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RepeticionesModel());
