...
import 'detalles2425_model.dart';
export 'detalles2425_model.dart';

class Detalles2425Widget extends StatefulWidget {
  const Detalles2425Widget({
    super.key,
    required this.foto,
  ...
  @override
  State<Detalles2425Widget> createState() => _Detalles2425WidgetState();
}

class _Detalles2425WidgetState extends State<Detalles2425Widget>
    with TickerProviderStateMixin {
  late Detalles2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Detalles2425Model());
