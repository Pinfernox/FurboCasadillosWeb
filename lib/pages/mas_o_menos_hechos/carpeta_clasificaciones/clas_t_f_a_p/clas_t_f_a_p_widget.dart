...
import 'clas_t_f_a_p_model.dart';
export 'clas_t_f_a_p_model.dart';

class ClasTFAPWidget extends StatefulWidget {
  const ClasTFAPWidget({super.key});

  @override
  State<ClasTFAPWidget> createState() => _ClasTFAPWidgetState();
}

class _ClasTFAPWidgetState extends State<ClasTFAPWidget> {
  late ClasTFAPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasTFAPModel());
