...
import 'clas_victorias_model.dart';
export 'clas_victorias_model.dart';

class ClasVictoriasWidget extends StatefulWidget {
  const ClasVictoriasWidget({super.key});

  @override
  State<ClasVictoriasWidget> createState() => _ClasVictoriasWidgetState();
}

class _ClasVictoriasWidgetState extends State<ClasVictoriasWidget> {
  late ClasVictoriasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasVictoriasModel());
