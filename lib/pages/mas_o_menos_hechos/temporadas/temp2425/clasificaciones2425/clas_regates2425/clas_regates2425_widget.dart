...
import 'clas_regates2425_model.dart';
export 'clas_regates2425_model.dart';

class ClasRegates2425Widget extends StatefulWidget {
  const ClasRegates2425Widget({super.key});

  @override
  State<ClasRegates2425Widget> createState() => _ClasRegates2425WidgetState();
}

class _ClasRegates2425WidgetState extends State<ClasRegates2425Widget> {
  late ClasRegates2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasRegates2425Model());
