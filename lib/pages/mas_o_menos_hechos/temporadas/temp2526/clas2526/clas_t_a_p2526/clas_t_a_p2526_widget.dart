...
import 'clas_t_a_p2526_model.dart';
export 'clas_t_a_p2526_model.dart';

class ClasTAP2526Widget extends StatefulWidget {
  const ClasTAP2526Widget({super.key});

  @override
  State<ClasTAP2526Widget> createState() => _ClasTAP2526WidgetState();
}

class _ClasTAP2526WidgetState extends State<ClasTAP2526Widget> {
  late ClasTAP2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasTAP2526Model());
