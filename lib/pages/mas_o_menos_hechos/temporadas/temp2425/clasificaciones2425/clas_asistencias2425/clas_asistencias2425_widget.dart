...
import 'clas_asistencias2425_model.dart';
export 'clas_asistencias2425_model.dart';

class ClasAsistencias2425Widget extends StatefulWidget {
  const ClasAsistencias2425Widget({super.key});

  @override
  State<ClasAsistencias2425Widget> createState() =>
      _ClasAsistencias2425WidgetState();
}

class _ClasAsistencias2425WidgetState extends State<ClasAsistencias2425Widget> {
  late ClasAsistencias2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasAsistencias2425Model());
