...
import 'clas_goles2425_model.dart';
export 'clas_goles2425_model.dart';

class ClasGoles2425Widget extends StatefulWidget {
  const ClasGoles2425Widget({super.key});

  @override
  State<ClasGoles2425Widget> createState() => _ClasGoles2425WidgetState();
}

class _ClasGoles2425WidgetState extends State<ClasGoles2425Widget> {
  late ClasGoles2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasGoles2425Model());
