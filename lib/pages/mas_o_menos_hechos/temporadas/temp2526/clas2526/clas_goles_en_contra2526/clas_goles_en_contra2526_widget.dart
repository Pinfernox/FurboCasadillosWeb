...
import 'clas_goles_en_contra2526_model.dart';
export 'clas_goles_en_contra2526_model.dart';

class ClasGolesEnContra2526Widget extends StatefulWidget {
  const ClasGolesEnContra2526Widget({super.key});

  @override
  State<ClasGolesEnContra2526Widget> createState() =>
      _ClasGolesEnContra2526WidgetState();
}

class _ClasGolesEnContra2526WidgetState
    extends State<ClasGolesEnContra2526Widget> {
  late ClasGolesEnContra2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasGolesEnContra2526Model());
