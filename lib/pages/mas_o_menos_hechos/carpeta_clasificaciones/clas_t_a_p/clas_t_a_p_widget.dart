...
import 'clas_t_a_p_model.dart';
export 'clas_t_a_p_model.dart';

class ClasTAPWidget extends StatefulWidget {
  const ClasTAPWidget({super.key});

  @override
  State<ClasTAPWidget> createState() => _ClasTAPWidgetState();
}

class _ClasTAPWidgetState extends State<ClasTAPWidget> {
  late ClasTAPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasTAPModel());
