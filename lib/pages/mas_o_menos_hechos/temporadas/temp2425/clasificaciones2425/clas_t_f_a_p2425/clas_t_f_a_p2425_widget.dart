...
import 'clas_t_f_a_p2425_model.dart';
export 'clas_t_f_a_p2425_model.dart';

class ClasTFAP2425Widget extends StatefulWidget {
  const ClasTFAP2425Widget({super.key});

  @override
  State<ClasTFAP2425Widget> createState() => _ClasTFAP2425WidgetState();
}

class _ClasTFAP2425WidgetState extends State<ClasTFAP2425Widget> {
  late ClasTFAP2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasTFAP2425Model());
