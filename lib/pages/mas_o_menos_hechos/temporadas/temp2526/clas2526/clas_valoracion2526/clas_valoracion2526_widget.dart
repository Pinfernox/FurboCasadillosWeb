...
import 'clas_valoracion2526_model.dart';
export 'clas_valoracion2526_model.dart';

class ClasValoracion2526Widget extends StatefulWidget {
  const ClasValoracion2526Widget({super.key});

  @override
  State<ClasValoracion2526Widget> createState() =>
      _ClasValoracion2526WidgetState();
}

class _ClasValoracion2526WidgetState extends State<ClasValoracion2526Widget> {
  late ClasValoracion2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasValoracion2526Model());
