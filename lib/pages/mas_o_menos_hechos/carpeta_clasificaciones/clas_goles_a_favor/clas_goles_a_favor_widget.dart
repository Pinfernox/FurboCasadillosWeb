...
import 'clas_goles_a_favor_model.dart';
export 'clas_goles_a_favor_model.dart';

class ClasGolesAFavorWidget extends StatefulWidget {
  const ClasGolesAFavorWidget({super.key});

  @override
  State<ClasGolesAFavorWidget> createState() => _ClasGolesAFavorWidgetState();
}

class _ClasGolesAFavorWidgetState extends State<ClasGolesAFavorWidget> {
  late ClasGolesAFavorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasGolesAFavorModel());
