...
import 'clas_regates2526_model.dart';
export 'clas_regates2526_model.dart';

class ClasRegates2526Widget extends StatefulWidget {
  const ClasRegates2526Widget({super.key});

  @override
  State<ClasRegates2526Widget> createState() => _ClasRegates2526WidgetState();
}

class _ClasRegates2526WidgetState extends State<ClasRegates2526Widget> {
  late ClasRegates2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasRegates2526Model());
