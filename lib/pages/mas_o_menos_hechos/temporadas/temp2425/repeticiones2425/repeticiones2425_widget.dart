...
import 'repeticiones2425_model.dart';
export 'repeticiones2425_model.dart';

class Repeticiones2425Widget extends StatefulWidget {
  const Repeticiones2425Widget({super.key});

  @override
  State<Repeticiones2425Widget> createState() => _Repeticiones2425WidgetState();
}

class _Repeticiones2425WidgetState extends State<Repeticiones2425Widget> {
  late Repeticiones2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Repeticiones2425Model());
