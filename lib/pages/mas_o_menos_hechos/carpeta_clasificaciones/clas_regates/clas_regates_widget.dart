...
import 'clas_regates_model.dart';
export 'clas_regates_model.dart';

class ClasRegatesWidget extends StatefulWidget {
  const ClasRegatesWidget({super.key});

  @override
  State<ClasRegatesWidget> createState() => _ClasRegatesWidgetState();
}

class _ClasRegatesWidgetState extends State<ClasRegatesWidget> {
  late ClasRegatesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasRegatesModel());
