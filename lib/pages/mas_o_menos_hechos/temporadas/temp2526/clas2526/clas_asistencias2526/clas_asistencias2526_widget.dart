...
import 'clas_asistencias2526_model.dart';
export 'clas_asistencias2526_model.dart';

class ClasAsistencias2526Widget extends StatefulWidget {
  const ClasAsistencias2526Widget({super.key});

  @override
  State<ClasAsistencias2526Widget> createState() =>
      _ClasAsistencias2526WidgetState();
}

class _ClasAsistencias2526WidgetState extends State<ClasAsistencias2526Widget> {
  late ClasAsistencias2526Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasAsistencias2526Model());
