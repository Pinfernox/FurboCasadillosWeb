...
import 'clas_asistencias_model.dart';
export 'clas_asistencias_model.dart';

class ClasAsistenciasWidget extends StatefulWidget {
  const ClasAsistenciasWidget({super.key});

  @override
  State<ClasAsistenciasWidget> createState() => _ClasAsistenciasWidgetState();
}

class _ClasAsistenciasWidgetState extends State<ClasAsistenciasWidget> {
  late ClasAsistenciasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasAsistenciasModel());
