...
import 'clas_t_a_p2425_model.dart';
export 'clas_t_a_p2425_model.dart';

class ClasTAP2425Widget extends StatefulWidget {
  const ClasTAP2425Widget({super.key});

  @override
  State<ClasTAP2425Widget> createState() => _ClasTAP2425WidgetState();
}

class _ClasTAP2425WidgetState extends State<ClasTAP2425Widget> {
  late ClasTAP2425Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClasTAP2425Model());
